            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Material Price</h4>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
																			<?php
																				...
																				$sqlAllMaterials = "SELECT mat.materialName,mat.materialId,mod.modelName,mod.modelId,com.companyId,mod.modelPrice
																				...
																				while( $row = sqlsrv_fetch_array( $stmtAllMaterials, SQLSRV_FETCH_ASSOC) ) {
																						...
																						</tr>",$row['materialName'],$row['modelName'],$row['modelPrice'],$row['modelId']);
																					}
