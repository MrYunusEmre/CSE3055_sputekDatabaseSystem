      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">SULAMA SİSTEMİ</a>
          </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            ...
            <img src="sulama.jpg" width="600" height="400" alt="sputek" ALIGN="left" style="padding: 5px;">
            ...
            <div class="container">
              ...
              if( $conn ) {
               ...
               $sql = "SELECT productPrice From Product WHERE productId = 4";
