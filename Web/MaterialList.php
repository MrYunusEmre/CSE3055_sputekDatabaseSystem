		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Material List</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Material Count</h4>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
																			<?php
																				...
																				$sqlProcedureAllMaterialAndModelCounts = "exec ProcedureAllMaterialAndModelCounts";
																				...
																				while( $row = sqlsrv_fetch_array( $stmtAllMaterials, SQLSRV_FETCH_ASSOC) ) {
																						...
																						<tr>
																							...
																							<td>%s</td>
																							<td>
																								<form method=post action=buyMaterial.php>
																								  <input type=hidden size=1 class=form__field value=%s name=modelId id='modelId' readonly />
																									<input type=input class=form__field placeholder=Ssn name=Ssn id='Ssn' required />
																									<input type=input size=4 class=form__field placeholder=Count name=Count id='Count' required />
																									<button>Buy</button>
																								</form>
																							</td>
																						</tr>",$row['materialName'],$row['modelName'],$row['companyName'],$row['modelCount'],$row['modelId']);
																					}
