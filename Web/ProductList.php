            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Product Count</h4>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
																			<?php
																				...
																				$sqlProcedureAllProductsAndCounts = "SELECT * FROM Product p inner join Product_Storage ps on p.productId=ps.productId";

																				$stmtProcedureAllProductsAndCounts = sqlsrv_query( $conn, $sqlProcedureAllProductsAndCounts );

																				while( $row = sqlsrv_fetch_array( $stmtProcedureAllProductsAndCounts, SQLSRV_FETCH_ASSOC) ) {
																						printf("
																						<tr>
																							<td>%s</td>
																							<td>%s</td>
                                                  ...
                                                  <input type=hidden size=1 class=form__field value=%s name=productId id='productId' readonly />
																									<input type=input class=form__field placeholder=Ssn name=Ssn id='Ssn' required />
																									<input type=input class=form__field placeholder=Count name=Count id='Count' required />
																									<button>Update</button>
																								</form>
																							</td>
																						</tr>",$row['productName'],$row['productCount'],$row['productId']);
																					}
